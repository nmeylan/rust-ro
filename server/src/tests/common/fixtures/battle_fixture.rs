    ...
    fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: MapAccess<'de> {
        ...
        if let Some(bonus) = bonus {
            ...
            let bonus = match bonus.as_str() {
                ...
                "HpRegenPercentage" => BonusType::HpRegenPercentage(value.unwrap() as i8),
                "SpRegenPercentage" => BonusType::SpRegenPercentage(value.unwrap() as i8),
                ...
                "ChanceToInflictStatusPoisonOnAttackPercentage" => BonusType::ChanceToInflictStatusPoisonOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusStunOnAttackPercentage" => BonusType::ChanceToInflictStatusStunOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusFreezeOnAttackPercentage" => BonusType::ChanceToInflictStatusFreezeOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusCurseOnAttackPercentage" => BonusType::ChanceToInflictStatusCurseOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBlindOnAttackPercentage" => BonusType::ChanceToInflictStatusBlindOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusSleepOnAttackPercentage" => BonusType::ChanceToInflictStatusSleepOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusSilenceOnAttackPercentage" => BonusType::ChanceToInflictStatusSilenceOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBurningOnAttackPercentage" => BonusType::ChanceToInflictStatusBurningOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusChaosOnAttackPercentage" => BonusType::ChanceToInflictStatusChaosOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBleedingOnAttackPercentage" => BonusType::ChanceToInflictStatusBleedingOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusStoneOnAttackPercentage" => BonusType::ChanceToInflictStatusStoneOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusConfuseOnAttackPercentage" => BonusType::ChanceToInflictStatusConfuseOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusWeaponBreakOnAttackPercentage" => BonusType::ChanceToInflictStatusWeaponBreakOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusArmorBreakOnAttackPercentage" => BonusType::ChanceToInflictStatusArmorBreakOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackPercentage" => BonusType::ChanceToInflictStatusComaOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackOnBossClassPercentage" => BonusType::ChanceToInflictStatusComaOnAttackOnBossClassPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackOnNormalClassPercentage" => BonusType::ChanceToInflictStatusComaOnAttackOnNormalClassPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackOnGuardianClassPercentage" => BonusType::ChanceToInflictStatusComaOnAttackOnGuardianClassPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceFormlessPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceFormlessPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceUndeadPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceUndeadPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceBrutePercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceBrutePercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRacePlantPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRacePlantPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceInsectPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceInsectPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceFishPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceFishPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceDemonPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceDemonPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceDemiHumanPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceDemiHumanPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceAngelPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceAngelPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaOnAttackRaceDragonPercentage" => BonusType::ChanceToInflictStatusComaOnAttackRaceDragonPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusPoisonToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusPoisonToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusStunToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusStunToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusFreezeToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusFreezeToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusCurseToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusCurseToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBlindToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusBlindToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusSleepToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusSleepToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusSilenceToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusSilenceToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBurningToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusBurningToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusChaosToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusChaosToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBleedingToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusBleedingToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusStoneToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusStoneToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusConfuseToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusConfuseToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusWeaponBreakToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusWeaponBreakToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusArmorBreakToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusArmorBreakToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusComaToSelfOnAttackPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusPoisonWhenHitPercentage" => BonusType::ChanceToInflictStatusPoisonWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusStunWhenHitPercentage" => BonusType::ChanceToInflictStatusStunWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusFreezeWhenHitPercentage" => BonusType::ChanceToInflictStatusFreezeWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusCurseWhenHitPercentage" => BonusType::ChanceToInflictStatusCurseWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBlindWhenHitPercentage" => BonusType::ChanceToInflictStatusBlindWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusSleepWhenHitPercentage" => BonusType::ChanceToInflictStatusSleepWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusSilenceWhenHitPercentage" => BonusType::ChanceToInflictStatusSilenceWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBurningWhenHitPercentage" => BonusType::ChanceToInflictStatusBurningWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusChaosWhenHitPercentage" => BonusType::ChanceToInflictStatusChaosWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusBleedingWhenHitPercentage" => BonusType::ChanceToInflictStatusBleedingWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusStoneWhenHitPercentage" => BonusType::ChanceToInflictStatusStoneWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusConfuseWhenHitPercentage" => BonusType::ChanceToInflictStatusConfuseWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusWeaponBreakWhenHitPercentage" => BonusType::ChanceToInflictStatusWeaponBreakWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusArmorBreakWhenHitPercentage" => BonusType::ChanceToInflictStatusArmorBreakWhenHitPercentage(value.unwrap() as i8),
                "ChanceToInflictStatusComaWhenHitPercentage" => BonusType::ChanceToInflictStatusComaWhenHitPercentage(value.unwrap() as i8),
                ...
                "ResistanceToStatusConfusePercentage" => BonusType::ResistanceToStatusConfusePercentage(value.unwrap() as i8),
