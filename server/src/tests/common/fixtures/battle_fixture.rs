    ...
    fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: MapAccess<'de> {
        ...
        if let Some(bonus) = bonus {
            ...
            let bonus = match bonus.as_str() {
                ...
                "ChanceToInflictStatusConfuseOnAttackPercentage" => BonusType::ChanceToInflictStatusConfuseOnAttackPercentage(value.unwrap()as f32),
                ...
                "ChanceToInflictStatusConfuseToSelfOnAttackPercentage" => BonusType::ChanceToInflictStatusConfuseToSelfOnAttackPercentage(value.unwrap()as f32),
                ...
                "ChanceToInflictStatusConfuseWhenHitPercentage" => BonusType::ChanceToInflictStatusConfuseWhenHitPercentage(value.unwrap()as f32),
