    ...
    fn test_skilllist_should_return_list_of_skill_for_character_job() {
        ...
        let scenario = vec![
            ...
            Scenarii {
                ...
                job_level: 1,
                skills: vec![Skill { value: enums::skills::Skill::from_name("NV_BASIC"), level: 8 }],
                expected_skills: vec![
                    Skill { value: enums::skills::Skill::from_name("NV_BASIC"), level: 8 }, ],
            },
            Scenarii {
                job: JobName::Swordsman.value(),
                job_level: 1,
                skills: vec![Skill { value: enums::skills::Skill::from_name("NV_BASIC"), level: 8 }, Skill { value: enums::skills::Skill::from_name("NV_TRICKDEAD"), level: 1 }],
                expected_skills: vec![
                    Skill { value: enums::skills::Skill::from_name("NV_BASIC"), level: 8 },
                    Skill { value: enums::skills::Skill::from_name("NV_TRICKDEAD"), level: 1 }, ],
            },
            Scenarii {
                job: JobName::Swordsman.value(),
                job_level: 1,
