...
mod tests {
    ...
    fn test_skilllist_should_return_list_of_skill_for_character_job() {
        ...
        // var a = ""; temp0.skillList.forEach((s) => a += "Skill {value:
        // skills::skill_enums::Skill::from_name(\""+s.skillName+"\"), level:"+
        // s.level+"},\n"); console.log(a)
        let scenario = vec![
            Scenarii {
            ...
            Scenarii {
                ...
                skills: vec![
                    ...
                    KnownSkill {
                        value: SkillEnum::from_name("NV_TRICKDEAD"),
                        level: 1,
                    },
                ],
                expected_skills: vec![
            ...
            Scenarii {
                ...
                expected_skills: vec![
                    ...
                    KnownSkill {
                        value: SkillEnum::from_name("KN_SPEARBOOMERANG"),
                        level: 0,
                    },
                    KnownSkill {
                        value: SkillEnum::from_name("KN_TWOHANDQUICKEN"),
            ...
            Scenarii {
                ...
                expected_skills: vec![
                    ...
                    KnownSkill {
                        value: SkillEnum::from_name("LK_AURABLADE"),
                        level: 0,
                    },
                    KnownSkill {
                        value: SkillEnum::from_name("LK_PARRYING"),
                        level: 0,
                    },
                ],
            },
            Scenarii {
                ...
                expected_skills: vec![
                    ...
                    KnownSkill {
                        value: SkillEnum::from_name("LK_BERSERK"),
                        level: 0,
                    },
                    KnownSkill {
                        value: SkillEnum::from_name("KN_TWOHANDQUICKEN"),
        ...
        for scenarii in scenario {
            ...
            // Then
            let skills_list_str = skills.iter().fold(String::new(), |memo, skill| {
                format!("{}\n Skill {} - lvl {}", memo, skill.value.to_name(), skill.level)
            });
            assert_eq!(
                skills.len(),
                scenarii.expected_skills.len(),
                "Scenarii {} - Expected job {} to have {} skills but got {}. Received list was \n{}",
                i,
                JobName::from_value(character.status.job as usize).as_str(),
                scenarii.expected_skills.len(),
                skills.len(),
                skills_list_str
            );
            for skill in scenarii.expected_skills {
                assert!(
                    ...
                    "Scenarii {} - Expected {} to be included among following list but was not \n{}",
                    i,
                    skill.value.to_name(),
                    skills_list_str
                )
