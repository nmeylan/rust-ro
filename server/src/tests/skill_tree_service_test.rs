...
mod tests {
    ...
    fn test_skilllist_should_return_list_of_skill_for_character_job() {
        ...
        let scenario = vec![
            Scenarii { job: JobName::Novice.value(), job_level: 1, skills: vec![], expected_skills: vec![KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 0 }] },
            Scenarii {
                job: JobName::Swordsman.value(),
                job_level: 1,
                skills: vec![KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 8 }],
                expected_skills: vec![
                    KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 8 }, ],
            },
            Scenarii {
                job: JobName::Swordsman.value(),
                job_level: 1,
                skills: vec![KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 8 }, KnownSkill { value: SkillEnum::from_name("NV_TRICKDEAD"), level: 1 }],
                expected_skills: vec![
                    KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 8 },
                    KnownSkill { value: SkillEnum::from_name("NV_TRICKDEAD"), level: 1 }, ],
            },
            Scenarii {
                job: JobName::Swordsman.value(),
                job_level: 1,
                ...
                expected_skills: vec![
                    KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 9 },
                    KnownSkill { value: SkillEnum::from_name("SM_SWORD"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("SM_RECOVERY"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("SM_BASH"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("SM_PROVOKE"), level: 0 }, ],
            }, Scenarii {
                job: JobName::Swordsman.value(),
                job_level: 1,
                skills: vec![KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 9 },
                ...
                expected_skills: vec![
                    KnownSkill { value: SkillEnum::from_name("NV_BASIC"), level: 9 },
                    KnownSkill { value: SkillEnum::from_name("SM_SWORD"), level: 10 },
                    KnownSkill { value: SkillEnum::from_name("SM_TWOHAND"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("SM_RECOVERY"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("SM_BASH"), level: 6 },
                    KnownSkill { value: SkillEnum::from_name("SM_PROVOKE"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("SM_MAGNUM"), level: 0 }, ],
            }, Scenarii {
                ...
                expected_skills: vec![
                    ...
                    KnownSkill { value: SkillEnum::from_name("KN_SPEARMASTERY"), level: 1 },
                    KnownSkill { value: SkillEnum::from_name("KN_PIERCE"), level: 3 },
                    KnownSkill { value: SkillEnum::from_name("KN_SPEARBOOMERANG"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("KN_TWOHANDQUICKEN"), level: 8 },
                    KnownSkill { value: SkillEnum::from_name("KN_AUTOCOUNTER"), level: 5 },
                    KnownSkill { value: SkillEnum::from_name("KN_RIDING"), level: 1 },
                    KnownSkill { value: SkillEnum::from_name("KN_CAVALIERMASTERY"), level: 5 }, ],
                ...
                expected_skills: vec![
                    ...
                    KnownSkill { value: SkillEnum::from_name("KN_RIDING"), level: 1 },
                    KnownSkill { value: SkillEnum::from_name("KN_CAVALIERMASTERY"), level: 5 },
                    KnownSkill { value: SkillEnum::from_name("LK_AURABLADE"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("LK_PARRYING"), level: 0 }, ],
            },
            Scenarii {
                job: JobName::LordKnight.value(),
                job_level: 50,
                ...
                expected_skills: vec![
                    ...
                    KnownSkill { value: SkillEnum::from_name("KN_PIERCE"), level: 3 },
                    KnownSkill { value: SkillEnum::from_name("KN_SPEARBOOMERANG"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("LK_BERSERK"), level: 0 },
                    KnownSkill { value: SkillEnum::from_name("KN_TWOHANDQUICKEN"), level: 8 },
                    KnownSkill { value: SkillEnum::from_name("KN_AUTOCOUNTER"), level: 5 },
                    KnownSkill { value: SkillEnum::from_name("KN_RIDING"), level: 1 },
                    KnownSkill { value: SkillEnum::from_name("KN_CAVALIERMASTERY"), level: 5 },
