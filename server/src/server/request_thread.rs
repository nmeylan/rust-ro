/// This thread handle client incoming requests
...
pub fn build(server_ref: Arc<Server>, port: u16, response_sender: SyncSender<Response>, client_notification_sender: SyncSender<Notification>) -> JoinHandle<()> {
