...
impl SkillBase for MusicLessons {
    ...
    fn _bonuses_to_self(&self, tick: u128) -> TemporaryStatusBonuses {
        if self.level == 1 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 3),
        ...
        if self.level == 2 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 6),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 3 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 9),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 4 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 12),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 5 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 15),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 6 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 18),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 7 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 21),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 8 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 24),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 9 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 27),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
        ...
        if self.level == 10 {
            return TemporaryStatusBonuses::new(vec![
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::MasteryDamageUsingWeaponType(Musical, 30),
                    StatusBonusFlag::Default.as_flag(),
                    315,
                ),
...
impl SkillBase for MelodyStrike {
    ...
    fn _validate_weapon(&self, status: &StatusSnapshot) -> SkillRequirementResult<()> {
        if let Some(character_weapon) = status.right_hand_weapon() {
            if 8192 & character_weapon.weapon_type().as_flag() > 0 {
                Ok(())
            } else {
                Err(())
            }
...
impl SkillBase for DownTempo {
    ...
    fn _bonuses_to_self(&self, tick: u128) -> TemporaryStatusBonuses {
        if self.level == 1 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::VitDefPercentage(-100),
                0,
                tick,
                60000,
                308,
...
impl SkillBase for HarmonicLick {
    ...
    fn _bonuses_to_self(&self, tick: u128) -> TemporaryStatusBonuses {
        if self.level == 1 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::MasteryDamageUsingWeaponType(AllWeaponType, 75),
                0,
                tick,
                60000,
                310,
        ...
        if self.level == 2 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::MasteryDamageUsingWeaponType(AllWeaponType, 100),
                0,
                tick,
                60000,
                310,
        ...
        if self.level == 3 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::MasteryDamageUsingWeaponType(AllWeaponType, 125),
                0,
                tick,
                60000,
                310,
        ...
        if self.level == 4 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::MasteryDamageUsingWeaponType(AllWeaponType, -106),
                0,
                tick,
                60000,
                310,
        ...
        if self.level == 5 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::MasteryDamageUsingWeaponType(AllWeaponType, -81),
                0,
                tick,
                60000,
                310,
...
impl SkillBase for AcousticRhythm {
    ...
    fn _bonuses_to_self(&self, tick: u128) -> TemporaryStatusBonuses {
        if self.level == 1 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::ResistanceToStatusPercentage(AllStatusEffect, 10.0),
                0,
                tick,
                60000,
                313,
        ...
        if self.level == 2 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::ResistanceToStatusPercentage(AllStatusEffect, 20.0),
                0,
                tick,
                60000,
                313,
        ...
        if self.level == 3 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::ResistanceToStatusPercentage(AllStatusEffect, 30.0),
                0,
                tick,
                60000,
                313,
        ...
        if self.level == 4 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::ResistanceToStatusPercentage(AllStatusEffect, 40.0),
                0,
                tick,
                60000,
                313,
        ...
        if self.level == 5 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::ResistanceToStatusPercentage(AllStatusEffect, 50.0),
                0,
                tick,
                60000,
                313,
