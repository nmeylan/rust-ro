...
impl SkillBase for AuraBlade {
    ...
    fn _validate_weapon(&self, status: &StatusSnapshot) -> SkillRequirementResult<()> {
        if let Some(character_weapon) = status.right_hand_weapon() {
            if 8388606 & character_weapon.weapon_type().as_flag() > 0 {
                Ok(())
            } else {
                Err(())
            }
...
impl SkillBase for Parrying {
    ...
    fn _bonuses_to_self(&self, tick: u128) -> TemporaryStatusBonuses {
        ...
        if self.level == 3 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(15),
                14,
                tick,
                25000,
                356,
        ...
        if self.level == 4 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(20),
                14,
                tick,
                30000,
                356,
        ...
        if self.level == 5 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(25),
                14,
                tick,
                35000,
                356,
        ...
        if self.level == 6 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(30),
                14,
                tick,
                40000,
                356,
        ...
        if self.level == 7 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(35),
                14,
                tick,
                45000,
                356,
        ...
        if self.level == 8 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(40),
                14,
                tick,
                50000,
                356,
        ...
        if self.level == 9 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(45),
                14,
                tick,
                55000,
                356,
        ...
        if self.level == 10 {
            return TemporaryStatusBonuses::new(vec![TemporaryStatusBonus::with_duration(
                BonusType::PhysicalAttackBlockChancePercentage(50),
                14,
                tick,
                60000,
                356,
