    ...
    fn _bonuses_to_self(&self, tick: u128) -> TemporaryStatusBonuses {
        if self.level == 1 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 5.0),
        ...
        if self.level == 2 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 10.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 3 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 15.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 4 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 20.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 5 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 25.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 6 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 30.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 7 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 35.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 8 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 40.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 9 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 45.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
        ...
        if self.level == 10 {
            return TemporaryStatusBonuses::new(vec![
                ...
                TemporaryStatusBonus::with_passive_skill(
                    BonusType::AutospellSkillIdChancePercentage(48, 50.0),
                    StatusBonusFlag::Default.as_flag(),
                    48,
                ),
            ]);
