...
impl OffensiveSkill for VulcanArrow {
}
...
impl SupportiveSkill for MarionetteControl {
}
...
impl SelfSkill for WandofHermode {
}
impl PerformanceSkill for WandofHermode {
}
...
impl OffensiveSkill for TarotCardofFate {
}
