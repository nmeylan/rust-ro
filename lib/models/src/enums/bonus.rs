...
impl PartialEq for BonusType {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (BonusType::MeleeAttackReflectChancePercentage(_), BonusType::MeleeAttackReflectChancePercentage(_)) => true,
...
impl BonusType {
    ...
    pub fn get_bonus_sum(bonus: &BonusType, bonuses: &Vec<BonusType>) -> BonusType {
        let val: i32 = bonuses.into_iter().filter_map(|b|
            if b == bonus {
                match b {
                    ...
                    BonusType::MeleeAttackReflectChancePercentage(val) => Some(*val as i32),
        ...
        match bonus {
            ...
            BonusType::MeleeAttackReflectChancePercentage(_) => BonusType::MeleeAttackReflectChancePercentage(val as i8),
