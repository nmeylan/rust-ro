...
impl PartialEq for BonusType {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            (BonusType::Str(_), BonusType::Str(_)) => true,
            (BonusType::Agi(_), BonusType::Agi(_)) => true,
            (BonusType::Vit(_), BonusType::Vit(_)) => true,
            (BonusType::Int(_), BonusType::Int(_)) => true,
            (BonusType::Dex(_), BonusType::Dex(_)) => true,
            (BonusType::Luk(_), BonusType::Luk(_)) => true,
            ...
            (BonusType::Aspd(_), BonusType::Aspd(_)) => true,
            (BonusType::AspdPercentage(_), BonusType::AspdPercentage(_)) => true,
            (BonusType::Maxhp(_), BonusType::Maxhp(_)) => true,
            (BonusType::Maxsp(_), BonusType::Maxsp(_)) => true,
            (BonusType::MaxhpPercentage(_), BonusType::MaxhpPercentage(_)) => true,
            (BonusType::MaxspPercentage(_), BonusType::MaxspPercentage(_)) => true,
            (BonusType::Atk(_), BonusType::Atk(_)) => true,
            (BonusType::Def(_), BonusType::Def(_)) => true,
            (BonusType::VitDefPercentage(_), BonusType::VitDefPercentage(_)) => true,
            (BonusType::DefPercentage(_), BonusType::DefPercentage(_)) => true,
            (BonusType::Mdef(_), BonusType::Mdef(_)) => true,
            (BonusType::Matk(_), BonusType::Matk(_)) => true,
            (BonusType::MatkBasedOnStaffPercentage(_), BonusType::MatkBasedOnStaffPercentage(_)) => true,
            (BonusType::MatkPercentage(_), BonusType::MatkPercentage(_)) => true,
            (BonusType::AtkPercentage(_), BonusType::AtkPercentage(_)) => true,
            (BonusType::PerfectHitPercentage(_), BonusType::PerfectHitPercentage(_)) => true,
            (BonusType::ElementWeapon(_), BonusType::ElementWeapon(_)) => true,
            (BonusType::ElementDefense(_), BonusType::ElementDefense(_)) => true,
            (BonusType::CriticalDamagePercentage(_), BonusType::CriticalDamagePercentage(_)) => true,
            (BonusType::CastTimePercentage(_), BonusType::CastTimePercentage(_)) => true,
            ...
            (BonusType::HpRegenFromCandyPercentage(_), BonusType::HpRegenFromCandyPercentage(_)) => true,
            (BonusType::HpRegenFromJuicePercentage(_), BonusType::HpRegenFromJuicePercentage(_)) => true,
            (BonusType::HpRegenFromFishPercentage(_), BonusType::HpRegenFromFishPercentage(_)) => true,
            (BonusType::HpRegenFromFoodPercentage(_), BonusType::HpRegenFromFoodPercentage(_)) => true,
            (BonusType::HpRegenFromPotionPercentage(_), BonusType::HpRegenFromPotionPercentage(_)) => true,
            (BonusType::GainHpWhenKillingEnemy(_), BonusType::GainHpWhenKillingEnemy(_)) => true,
            (BonusType::GainHpWhenKillingEnemyWithMagicAttack(_), BonusType::GainHpWhenKillingEnemyWithMagicAttack(_)) => true,
            (BonusType::GainSpWhenKillingEnemyWithMagicAttack(_), BonusType::GainSpWhenKillingEnemyWithMagicAttack(_)) => true,
            (BonusType::HpRegenFromSkillPercentage(_), BonusType::HpRegenFromSkillPercentage(_)) => true,
            (BonusType::GainSpWhenHittingEnemy(_), BonusType::GainSpWhenHittingEnemy(_)) => true,
            (BonusType::GainSpWhenKillingEnemy(_), BonusType::GainSpWhenKillingEnemy(_)) => true,
            ...
            (BonusType::NullifyAttackChancePercentage(_), BonusType::NullifyAttackChancePercentage(_)) => true,
            ...
            (BonusType::DoubleAttackChancePercentage(_), BonusType::DoubleAttackChancePercentage(_)) => true,
            (BonusType::HealSkillPercentage(_), BonusType::HealSkillPercentage(_)) => true,
            (BonusType::DamageRangedAtkPercentage(_), BonusType::DamageRangedAtkPercentage(_)) => true,
            (BonusType::ResistanceMagicAttackPercentage(_), BonusType::ResistanceMagicAttackPercentage(_)) => true,
            (BonusType::MagicAttackReflectChancePercentage(_), BonusType::MagicAttackReflectChancePercentage(_)) => true,
            (BonusType::PhysicalAttackReflectChancePercentage(_), BonusType::PhysicalAttackReflectChancePercentage(_)) => true,
            (BonusType::PhysicalAttackBlockChancePercentage(_), BonusType::PhysicalAttackBlockChancePercentage(_)) => true,
            (BonusType::SplashRadius(_), BonusType::SplashRadius(_)) => true,
            (BonusType::VisionDistance(_), BonusType::VisionDistance(_)) => true,
            (BonusType::SpeedPercentage(_), BonusType::SpeedPercentage(_)) => true,
            (BonusType::DropChanceJewelPercentage(_), BonusType::DropChanceJewelPercentage(_)) => true,
            (BonusType::DropChanceOrePercentage(_), BonusType::DropChanceOrePercentage(_)) => true,
            (BonusType::DropChanceRecoveryPercentage(_), BonusType::DropChanceRecoveryPercentage(_)) => true,
            (BonusType::DropChanceFoodPercentage(_), BonusType::DropChanceFoodPercentage(_)) => true,
            (BonusType::PhysicalDamageAgainstSizePercentage(variant1, _), BonusType::PhysicalDamageAgainstSizePercentage(variant2, _)) => variant1 == variant2,
            (BonusType::MagicalDamageAgainstSizePercentage(variant1, _), BonusType::MagicalDamageAgainstSizePercentage(variant2, _)) => variant1 == variant2,
            (BonusType::PhysicalDamageAgainstRacePercentage(variant1, _), BonusType::PhysicalDamageAgainstRacePercentage(variant2, _)) => variant1 == variant2,
            (BonusType::MagicalDamageAgainstRacePercentage(variant1, _), BonusType::MagicalDamageAgainstRacePercentage(variant2, _)) => variant1 == variant2,
            (BonusType::PhysicalDamageAgainstElementPercentage(variant1, _), BonusType::PhysicalDamageAgainstElementPercentage(variant2, _)) => variant1 == variant2,
            (BonusType::DamageAgainstMobGroupPercentage(variant1, _), BonusType::DamageAgainstMobGroupPercentage(variant2, _)) => variant1 == variant2,
            (BonusType::CriticalAgainstRacePercentage(variant1, _), BonusType::CriticalAgainstRacePercentage(variant2, _)) => variant1 == variant2,
            (BonusType::ChanceToInflictStatusComaOnAttackOnClassPercentage(variant1, _), BonusType::ChanceToInflictStatusComaOnAttackOnClassPercentage(variant2, _)) => variant1 == variant2,
            (BonusType::ChanceToInflictStatusComaOnAttackOnRacePercentage(variant1, _), BonusType::ChanceToInflictStatusComaOnAttackOnRacePercentage(variant2, _)) => variant1 == variant2,
            ...
            (BonusType::ResistanceDamageFromSizePercentage(variant1, _), BonusType::ResistanceDamageFromSizePercentage(variant2, _)) => variant1 == variant2,
            (BonusType::IgnoreDefClass(variant1), BonusType::IgnoreDefClass(variant2)) => variant1 == variant2,
            (BonusType::IgnoreDefRace(variant1), BonusType::IgnoreDefRace(variant2)) => variant1 == variant2,
            (BonusType::IgnoreDefRacePercentage(variant1, _), BonusType::IgnoreDefRacePercentage(variant2, _)) => variant1 == variant2,
            (BonusType::IgnoreMDefRacePercentage(variant1, _), BonusType::IgnoreMDefRacePercentage(variant2, _)) => variant1 == variant2,
            ...
            (BonusType::SpDrainWhenAttackingRace(variant1, _), BonusType::SpDrainWhenAttackingRace(variant2, _)) => variant1 == variant2,
            (BonusType::SpDrainWhenKillingRace(variant1, _), BonusType::SpDrainWhenKillingRace(variant2, _)) => variant1 == variant2,
            (BonusType::CastTimeWhenUsingSkillIdPercentage(variant1, _), BonusType::CastTimeWhenUsingSkillIdPercentage(variant2, _)) => variant1 == variant2,
            (BonusType::HpRegenFromItemIDPercentage(variant1, _), BonusType::HpRegenFromItemIDPercentage(variant2, _)) => *variant1 == *variant2,
            (BonusType::HealSkillIdPercentage(variant1, _), BonusType::HealSkillIdPercentage(variant2, _)) => *variant1 == *variant2,
            (BonusType::ResistancePhysicalAttackFromMobIdPercentage(variant1, _), BonusType::ResistancePhysicalAttackFromMobIdPercentage(variant2, _)) => *variant1 == *variant2,
            (BonusType::DropChanceItemIdPercentage(variant1, _), BonusType::DropChanceItemIdPercentage(variant2, _)) => *variant1 == *variant2,
            (BonusType::KnockbackWhenUsingSkillId(variant1, _), BonusType::KnockbackWhenUsingSkillId(variant2, _)) => *variant1 == *variant2,
            (BonusType::GainZenyWhenKillingMonster(variant1, _), BonusType::GainZenyWhenKillingMonster(variant2, _)) => *variant1 == *variant2,
            (BonusType::HpLossEveryMs(_, variant1), BonusType::HpLossEveryMs(_, variant2)) => *variant1 == *variant2,
            ...
            (BonusType::EnableSeeHidden, BonusType::EnableSeeHidden) => true,
            (BonusType::EnableNoCancelCast, BonusType::EnableNoCancelCast) => true,
            (BonusType::EnableNoGemstoneRequired, BonusType::EnableNoGemstoneRequired) => true,
            (BonusType::EnableIgnoreSizeModifier, BonusType::EnableIgnoreSizeModifier) => true,
            (BonusType::EnableNoKnockback, BonusType::EnableNoKnockback) => true,
            (BonusType::EnableNoWalkDelay, BonusType::EnableNoWalkDelay) => true,
            (BonusType::UnbreakableArmor, BonusType::UnbreakableArmor) => true,
            (BonusType::UnbreakableShoulder, BonusType::UnbreakableShoulder) => true,
            (BonusType::UnbreakableHelm, BonusType::UnbreakableHelm) => true,
            (BonusType::UnbreakableShield, BonusType::UnbreakableShield) => true,
            (BonusType::UnbreakableShoes, BonusType::UnbreakableShoes) => true,
            (BonusType::UnbreakableWeapon, BonusType::UnbreakableWeapon) => true,
            _ => false
        }
    }
}
