...
impl BonusType {
    ...
    pub fn get_bonus_sum(bonus: &BonusType, bonuses: &Vec<BonusType>) -> Option<BonusType> {
        let val: i32 = bonuses.into_iter().filter_map(|b| match (bonus, b) {
            ...
            (BonusType::HpRegenPercentage(_), BonusType::HpRegenPercentage(val)) => Some(*val as i32),
            (BonusType::SpRegenPercentage(_), BonusType::SpRegenPercentage(val)) => Some(*val as i32),
        ...
        match bonus {
            ...
            BonusType::HpRegenPercentage(_) => Some(BonusType::HpRegenPercentage(val as i8)),
            BonusType::SpRegenPercentage(_) => Some(BonusType::SpRegenPercentage(val as i8)),
            ...
            BonusType::ChanceToInflictStatusPoisonOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusPoisonOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusStunOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusStunOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusFreezeOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusFreezeOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusCurseOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusCurseOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBlindOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusBlindOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusSleepOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusSleepOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusSilenceOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusSilenceOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBurningOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusBurningOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusChaosOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusChaosOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBleedingOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusBleedingOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusStoneOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusStoneOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusConfuseOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusConfuseOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusWeaponBreakOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusWeaponBreakOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusArmorBreakOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusArmorBreakOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackOnBossClassPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackOnBossClassPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackOnNormalClassPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackOnNormalClassPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackOnGuardianClassPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackOnGuardianClassPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceFormlessPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceFormlessPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceUndeadPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceUndeadPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceBrutePercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceBrutePercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRacePlantPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRacePlantPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceInsectPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceInsectPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceFishPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceFishPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceDemonPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceDemonPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceDemiHumanPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceDemiHumanPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceAngelPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceAngelPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaOnAttackRaceDragonPercentage(_) => Some(BonusType::ChanceToInflictStatusComaOnAttackRaceDragonPercentage(val as i8)),
            BonusType::ChanceToInflictStatusPoisonToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusPoisonToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusStunToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusStunToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusFreezeToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusFreezeToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusCurseToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusCurseToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBlindToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusBlindToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusSleepToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusSleepToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusSilenceToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusSilenceToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBurningToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusBurningToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusChaosToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusChaosToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBleedingToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusBleedingToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusStoneToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusStoneToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusConfuseToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusConfuseToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusWeaponBreakToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusWeaponBreakToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusArmorBreakToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusArmorBreakToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaToSelfOnAttackPercentage(_) => Some(BonusType::ChanceToInflictStatusComaToSelfOnAttackPercentage(val as i8)),
            BonusType::ChanceToInflictStatusPoisonWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusPoisonWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusStunWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusStunWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusFreezeWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusFreezeWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusCurseWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusCurseWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBlindWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusBlindWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusSleepWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusSleepWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusSilenceWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusSilenceWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBurningWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusBurningWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusChaosWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusChaosWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusBleedingWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusBleedingWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusStoneWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusStoneWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusConfuseWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusConfuseWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusWeaponBreakWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusWeaponBreakWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusArmorBreakWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusArmorBreakWhenHitPercentage(val as i8)),
            BonusType::ChanceToInflictStatusComaWhenHitPercentage(_) => Some(BonusType::ChanceToInflictStatusComaWhenHitPercentage(val as i8)),
    ...
    pub fn get_bonus(bonus: &BonusType, bonuses: &Vec<BonusType>) -> Option<BonusType> {
        match bonus {
            ...
            BonusType::HpRegenPercentage(_) => bonuses.iter().find(|b| matches!(b, BonusType::HpRegenPercentage(_))).map(|b| b.clone()),
            BonusType::SpRegenPercentage(_) => bonuses.iter().find(|b| matches!(b, BonusType::SpRegenPercentage(_))).map(|b| b.clone()),
