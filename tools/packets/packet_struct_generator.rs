...
fn write_debug_trait(file: &mut File, struct_definition: &StructDefinition, is_packet: bool) {
    write_struct_info_trait(file, struct_definition, is_packet, true);
}

fn write_display_trait(file: &mut File, struct_definition: &StructDefinition, is_packet: bool) {
    write_struct_info_trait(file, struct_definition, is_packet, false);
}

fn write_struct_info_trait(file: &mut File, struct_definition: &StructDefinition, is_packet: bool, is_debug: bool) {
    let trait_name = if is_debug { "Debug".to_string() } else { "Display".to_string() };
    file.write(format!("impl {} for {} {{\n", trait_name, struct_definition.name).as_bytes());
