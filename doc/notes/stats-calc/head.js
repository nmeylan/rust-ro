...

{
    ...
    function BattleCalc999() {
        ...
        if (skillToUseName != "Basic Attack" && skillToUseName != "Sharp Shooting (Temp)" && (skillToUseName != "Poison React (Counter)" || (n_B[3] < 50 && 60 <= n_B[3]))) {
        ...
        if (n_A_WeaponType == 10 && skillToUseName === "Basic Attack")
            n_Enekyori = 1;

        if ((n_A_WeaponType == 17 || n_A_WeaponType == 18 || n_A_WeaponType == 19 || n_A_WeaponType == 20 || n_A_WeaponType == 21) && skillToUseName === "Basic Attack")
            n_Enekyori = 1;


        if (skillToUseName === "Basic Attack" || (skillToUseName === "Poison React (Counter)" && (50 <= n_B[3] && n_B[3] < 60))) {
        ...
        if (n_A_ActiveSkill === w_ActS[iw]) {
            ...
            if (skillToUseName === "Bash")
                ...
                if (skillToUseName === "Sonic Blow (Soul Linked)" && Taijin == 0)
                    skillModifier *= 2;
                if (skillToUseName === "Sonic Blow (Soul Linked)" && Taijin == 1)
                    skillModifier *= 1.25;
                wDelay = 2;
                swDelay = 2;
            ...
            for (b = 0; b <= 2; b++) {
                ...
                if (skillToUseName === "Beast Strafing" && n_B[2] != 2 && n_B[2] != 4)
                    finalDamages[b] = 0;
            ...
            BattleCalc998(wCast, wDelay);
            myInnerHtml("BattleHIT", 100, 0);
        } else if (skillToUseName === "Envenom" || (skillToUseName === "Poison React (Counter)" && (n_B[3] < 50 || 60 <= n_B[3]))) {
            applySkillModifier(skillModifier, 0);
