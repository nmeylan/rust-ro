...
Although I mentioned above wanting to fully support packet version **20120307**, this implementation can support any packet version, it is just I am testing exclusively with my own [open source client](https://github.com/nmeylan/nostalro-client) using this packet version and thus i am implementing only packet in this version.
